...
import { Plus, Newspaper, LogIn } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-serif text-2xl sm:text-3xl font-bold leading-tight">Posts</h2>
                <p className="text-primary-foreground/75 text-sm mt-0.5">Browse and manage posts</p>
              </div>
            </div>
            {isAuthenticated ? (
              <Button
          ...
          {!isAuthenticated && (
            <div className="mb-6 flex items-center gap-3 bg-accent border border-border rounded-lg px-4 py-3 text-sm text-muted-foreground">
              ...
              <span>
                ...
                to create, edit, or delete your own posts.
              </span>
            </div>
          )}
          <PostsList />
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            <DialogTitle className="font-serif text-lg font-bold">Create New Post</DialogTitle>
          </DialogHeader>
          <PostForm
